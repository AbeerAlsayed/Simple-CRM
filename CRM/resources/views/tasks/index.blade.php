...
@section('content')
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('tasks.create') }}" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded shadow">Create Task</a>
        </div>
            ...
            <table class="min-w-full">
                ...
                @foreach($tasks as $task)
                    <tr class="border-t hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('tasks.edit', $task) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded mr-2">Edit</a>
                ...
                @if ($tasks->isEmpty())
                    <tr>
                        <td colspan="4" class="text-center px-6 py-4 text-gray-500">No tasks found.</td>
                    </tr>
                @endif
                </tbody>
            </table>
